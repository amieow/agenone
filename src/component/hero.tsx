...
const Hero = () => {
    return (
        <section className="bg-[#0C111F] h-screen min-h-full ">
            ...
            <div className="bg-white bg-opacity-10 p-2 w-[262px] mx-auto rounded-[100px] mt-2 mb-2 transition-all">
            ...
            <div className=" px-6">
                ...
                <div className="flex bg-gradient-to-l from-teal-600 to-green-500 p-4 w-fit mx-auto mt-10 rounded-[100px] duration-150 transition-all hover:shadow-[0_0_30px_10px] cursor-pointer hover:shadow-cyan-500/50 hover:translate-x-2">

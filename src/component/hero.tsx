        ...
        >
            ...
            <ServerComponent>
                ...
                <div className="flex flex-col  h-[302px] mx-auto px-6 max-w-[877px] 975:h-[356px]">
                    <div>
                        <p className="font-bold text-4xl 425:text-5xl tracking-[-0.02em] w-fit  mx-auto leading-[44px] bg-gradient-to-l from-teal-600 to-green-500 text-transparent bg-clip-text 975:text-[72px] 975:pb-5">
                            Smart Choices
                        </p>
                    ...
                    <div className="flex bg-gradient-to-l from-teal-600 to-green-500 p-4 w-fit mx-auto mt-auto rounded-[100px] duration-150 transition-all md:hover:shadow-[0_0_30px_10px] cursor-pointer md:hover:shadow-cyan-500/50 md:hover:translate-x-2 ">
